...
public class GetReviewsForListingEndpointTests
{
    private static TestServer CreateServer()
    {
        var mediator = new Mock<IMediator>();
        mediator
            .Setup(m => m.Send(It.IsAny<GetReviewsForListingQuery>(), It.IsAny<CancellationToken>()))
        ...
        return new TestServer(new WebHostBuilder()
            ...
            .Configure(app =>
            {
                ...
                app.UseEndpoints(e => e.MapGetReviewsForListingEndpoint());
            }));
    }
    ...
    public async Task Get_WithAuth_ReturnsOk()
    {
        ...
        var res = await client.GetAsync($"/listings/{Guid.NewGuid()}/reviews");
